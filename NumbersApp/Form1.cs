...
namespace NumbersApp
{
    public partial class Form1 : Form
    {
        ...
        private char IntToChar(long input)
        {
            switch (input)
            {
                case 0:
        ...
        private String tenToAnotherInt(long number, int s)
        {
            long number_ = number;
            int k = 0;
            while (number > 0)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (comboBox1.Text == "10") //10->another
                {
                    ...
                    long data_int = (long)Convert.ToDouble(textBox1.Text) / 1;
                ...
                else
                {
                    ...
                    else if (z == true)
                    {
                        ...
                        long dat_int = (long)Convert.ToDouble(s) / 1;
